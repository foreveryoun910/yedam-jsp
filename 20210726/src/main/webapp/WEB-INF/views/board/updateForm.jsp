...
<body>
	<div align="center">
		...
		<form id="frm" name="frm" action="updateBoard.do" method="post">
				<div>
					<table border="1" style="border-collapse: collapse;">
						<tr>
							<th width="100">작성자</th>
							<td width="100">
								<input type="text" id="bWriter" name="bWriter" size="35" required="required" placeholder="${ n.bWriter }">
							</td>
				...
				<div>
					<button type="submit" onclick="location.href='updateBoard.do'">등록</button>&nbsp;&nbsp;&nbsp;
